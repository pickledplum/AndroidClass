...
public class BookmarksActivity extends Activity {
	...
	private void loadBookmarks() {
		...
		Cursor query = cr.query(Browser.BOOKMARKS_URI, projection, null, null, null);
		Log.d(TAG, "Got query cursor");
		if( query != null && query.moveToFirst() ){
			Log.d(TAG, "Seems like some bookmarks");
